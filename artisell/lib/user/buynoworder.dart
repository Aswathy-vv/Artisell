                      ...
                      child: Column(mainAxisAlignment: MainAxisAlignment.start,crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          phone.isNotEmpty ? Align(alignment:Alignment.centerLeft,child: Text(phone,style: TextStyle(fontSize: 15),)) : Text(
                              "Phone is empty"),
                          location.isNotEmpty ? Align(alignment:Alignment.centerLeft,child: Text(location,style: TextStyle(fontSize: 15),)) : Text(
                              "pincode is empty"),
                          itemname.isNotEmpty ? Container(height:100,width:200,child: Text(itemname,style: TextStyle(fontSize: 15),)) : Text(
                              "address is empty"),
